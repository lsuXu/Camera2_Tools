package com.xu.tool.camera.utils;
...
public class CameraUtils {
    ...
    public static Size getFitPreviewSize(Context context,String cameraId,int format,Size maxSize){
    ...
    public static Size getFitPreviewSize(List<Size> sizeList, Size maxSize){
        /**
    ...
    public static int getOrientation(Context context,String cameraId){
    ...
    //获取一个可用的相机ID
    public static String getDefaultCameraId(Context context) throws CameraAccessException {
    ...
    //校验相机ID是否可用
    public static boolean checkCameraId(Context context,String cameraId) throws CameraAccessException {
